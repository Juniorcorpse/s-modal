...
(function ($) {
    $.fn.smodal = function (options) {
        ...
        if (options.smodalname === 'app_modal_dialog') {
            options.smodalhtml = `<div class="d-flex justify-content-center"><div class="js-icon icon-notext al-center"></div></div>
        ...
        modalzindex = (options.smodalname == 'app_modal_dialog' ? 'z-index: 999;' : 'z-index: 998;');

        defaulthtml = `<div class="app_modal ${modalname}" smodalclose="true"
            style="left: 0; top: 0;right: 0;bottom: 0; background: rgba(100, 100, 100, 0.5); ${modalzindex}">
